...
const Products = () => {
    ...
    return (
      <div className="container mx-auto p-4 bg-[#fff6e1]">
        ...
        <Swiper spaceBetween={50} slidesPerView={3} loop={true} autoplay={{ delay: 3000 }} style={{ paddingTop: '10px',paddingRight: '15npx' }}>
