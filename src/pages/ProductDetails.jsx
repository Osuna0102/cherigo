...
const ProductDetail = () => {
    ...
    return (
        <div className="p-4 bg-[#fff6e1]  w-full flex" style={{ backgroundImage: "url('/assets/bgdecor.png')", backgroundSize: 'cover'}}>
        {/* Left Column - Back Button */}
        <div className="w-1/12 flex items-start">
        <button
            onClick={() => window.history.back()}
            className="m-4 bg-[#f66d76] text-white rounded-full hover:bg-[#eb8194] transition-colors duration-300"
        >
            <img src='/assets/back.png' alt='back' className='h-8 m-2'/>
        </button>
        </div>
