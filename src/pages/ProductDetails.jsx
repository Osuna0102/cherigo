...
const ProductDetail = () => {
    ...
    return (
        <div className="p-4 bg-[#fff6e1] w-full flex justify-center" style={{ backgroundImage: "url('/assets/bgdecor.png')", backgroundSize: 'cover' }}>
            ...
            <div className="flex flex-row max-w-[1400px] ">

            {/* Top Section - 2-column layout */}
            <div className="flex flex-row ">
                {/* Left Column - Product Image with Back Button */}
            ...
            <div className="px-8">
                ...
                <div className="border-t-2 border-[#ffbd59] mb-4 my-4"></div>
                <div className='font-[Dynapuff] text-red-400 font-bold mb-8'>
                    {Array.isArray(product.details)
                        ? product.details.map(block => block.children?.map(child => child.text).join('') || '').join(' ')
                        : ''}
                </div>
            </div>
        </div>            
